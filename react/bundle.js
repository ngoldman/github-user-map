...
/***/ function(module, exports, __webpack_require__) {
	...
	var _esriLeafletGeocoder = __webpack_require__(2);

	var _esriLeafletGeocoder2 = _interopRequireDefault(_esriLeafletGeocoder);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { id: 'app' },
	          _react2.default.createElement(SearchBox, { fetchUser: this.fetchUser }),
	    ...
	    value: function fetchApi(url) {
	      ...
	      fetch(url).then(function (res) {
	        ...
	        _esriLeafletGeocoder2.default.Tasks.geocode().text(data.location).run(function (err, body, response) {
	          if (err) console.log(err);
	          markers.clearLayers();
	          if (body.results[0]) {
	            var latlng = body.results[0].latlng;
	            markers.addLayer(_leaflet2.default.marker(latlng));
	    ...
	    value: function componentDidMount() {
	      map = _leaflet2.default.map('map').setView([0, 0], 2);
	...
	var SearchBox = function (_Component2) {
	  ...
	  function SearchBox(props) {
	    ...
	    var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(SearchBox).call(this, props));
	...
	SearchBox.propTypes = {
	  fetchUser: _react2.default.PropTypes.func
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! esri-leaflet-geocoder - v1.0.2 - 2015-07-15
	...
	*   Apache 2.0 License */
	...
	(function (factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = function (L, Esri) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! esri-leaflet - v1.0.3 - 2016-02-22
	*   Copyright (c) 2016 Environmental Systems Research Institute, Inc.
	*   Apache License*/
	(function (factory) {
	  //define an AMD module that relies on 'leaflet'
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function (L) {
	      return factory(L);
	    }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  //define a common js module that relies on 'leaflet'
	  } else if (typeof module === 'object' && typeof module.exports === 'object') {
